...
Revision ID: 94f9848c80f8
Revises: 
Create Date: 2026-01-09 02:59:07.183258
...
def upgrade() -> None:
    ...
    sa.Column('channel_portal', sa.Boolean(), nullable=False),
    sa.Column('channel_email', sa.Boolean(), nullable=False),
    sa.Column('channel_messenger', sa.Boolean(), nullable=False),
    sa.Column('digest_daily', sa.Boolean(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('now()'), nullable=False),
    sa.ForeignKeyConstraint(['user_eid'], ['employee.eid'], name=op.f('fk_notification_preferences_user_eid_employee'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_notification_preferences')),
    sa.UniqueConstraint('user_eid', name=op.f('uq_notification_preferences_user_eid'))
    )
    ...
    sa.ForeignKeyConstraint(['user_eid'], ['employee.eid'], name=op.f('fk_notifications_user_eid_employee'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_notifications')),
    sa.UniqueConstraint('user_eid', name=op.f('uq_notifications_user_eid'))
    )
    op.create_table('organization_change_log',
    sa.Column('id', sa.BigInteger(), autoincrement=True, nullable=False),
    sa.Column('org_unit_id', sa.BigInteger(), nullable=True, comment='ID подразделения, которое было изменено'),
    ...
    sa.ForeignKeyConstraint(['changed_by_eid'], ['employee.eid'], name=op.f('fk_organization_change_log_changed_by_eid_employee')),
    sa.ForeignKeyConstraint(['org_unit_id'], ['organization_unit.id'], name=op.f('fk_organization_change_log_org_unit_id_organization_unit')),
    sa.PrimaryKeyConstraint('id', name=op.f('pk_organization_change_log'))
    )
