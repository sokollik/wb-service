...
class CommentController:
    ...
    async def view_comments(
        ...
        return await self.comment_service.get_comments(news_id=news_id, sort_by=sort_by)
    ...
    async def create_comment(
        ...
        new_comment_id = await self.comment_service.create_comment(comment=comment)
    ...
    async def add_like(
        ...
        await self.comment_service.add_like(comment_id=comment_id, eid=current_user.eid)
    ...
    async def get_comment_edit_log(
        ...
        return await self.comment_service.get_comment_edit_log(comment_id=comment_id)
